            ...
            <div className={parseClasses()} style={styles}>
                <div className="smpladmin_Layout_TopHeader">
                    ...
                    <div>
                        ...
                        <i class="smpladmin_icon_logout_grey"></i>
                        <h3>Martin D.</h3>
                    </div>
                </div>
                <div className="smpladmin_Layout_MidBody">
                    <div className="smpladmin_Layout_SideBar">
                        {props.sidebarElements.map((se, seIndex) => {
                            ...
                            if (se.type === "section") {
                                return (
                                    <div class="smpladmin_Layout_SideBar_Section">
                                        {se.label}
                                    </div>
                                );
                            }
                        ...
                        <div class="smpladmin_Layout_Footer">
                            <span>Martin D.</span>
                            <i
                                class="smpladmin_icon_settings_white"
